	...
	<footer class="entry-meta">
		<?php
			...
			if ( ! web2feel_categorized_blog() ) {
				...
				if ( '' != $tag_list ) {
					$meta_text = __( 'این نوشته ارسال شده است در %1$s and tagged %2$s. Bookmark the <a href="%3$s" title="Permalink to %4$s" rel="bookmark">permalink</a>.', 'web2feel' );
				} else {
					$meta_text = __( 'این نوشته ارسال شده است در %1$s.  <a href="%3$s" title="Permalink to %4$s" rel="bookmark">بوک مارک</a>.', 'web2feel' );
				}
