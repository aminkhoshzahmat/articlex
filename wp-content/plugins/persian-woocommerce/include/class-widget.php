...
if ( ! class_exists( 'Persian_Wooommerce_Widget' ) ) :

class Persian_Wooommerce_Widget extends Persian_Wooommerce_Plugin {
	...
	public function woocommerce_persian_widgetshow() {		
		wp_add_dashboard_widget('woocommerce_persian_feed_'.str_replace(".", "_", PERSIAN_WOOCOMMERCE_VERSION).'_ver', 'آخرین اخبار و اطلاعیه های ووکامرس پارسی', array( $this, 'woocommerce_persian_widget') , array( $this, 'wooper_widset_pw') );
	}
...
$PW->widget = new Persian_Wooommerce_Widget();
